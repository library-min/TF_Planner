          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className={`text-xs ${
                isDarkMode ? 'text-gray-400' : 'text-gray-500'
              }`}>{getPercentage(animatedCounts.completed)}%</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className={`text-xs ${
                isDarkMode ? 'text-gray-400' : 'text-gray-500'
              }`}>{getPercentage(animatedCounts.inProgress)}%</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className={`text-xs ${
                isDarkMode ? 'text-gray-400' : 'text-gray-500'
              }`}>{getPercentage(animatedCounts.pending)}%</div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>완료된 작업</span>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>진행중인 작업</span>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>대기중인 작업</span>
        ...
        <Card title={t('dashboard.teamMemberStatus')}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {teamMembers.map((member) => (
              <div key={member.id} className={`text-center p-4 rounded-lg ${
                isDarkMode ? 'bg-gray-700' : 'bg-gray-50'
              }`}>
                {/* 사용자 아바타 (첫 글자) */}
