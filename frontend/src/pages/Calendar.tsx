...
const Calendar: React.FC = () => {
  ...
  const getDayClassName = (date: Date) => {
    // 달력 날짜는 항상 화이트 배경 유지 (다크모드 무관)
    let className = 'min-h-[100px] p-2 border border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors bg-white text-gray-900';
