            ...
            <Card key={task.id} className="hover:shadow-md transition-shadow">
              ...
              {selectedTaskId === task.id && (
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <h4 className="text-sm font-medium ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} mb-3">파일 첨부</h4>
                  <FileAttachment
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>작업 제목</label>
                <input
                  type="text"
                  value={newTask.title}
              ...
              <div>
                <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>설명</label>
                <textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>담당자</label>
                  <select 
                ...
                <div>
                  <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>우선순위</label>
                  <select 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>시작일</label>
                  <input
                    type="date"
              ...
              <div>
                <label className="block text-sm font-medium ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} mb-3">파일 첨부</label>
                <FileAttachment
                  files={[]}
                  onFilesChange={() => {}}
                />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>작업 설명</label>
                <textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className={`block text-sm font-medium mb-1 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>시작일 (선택사항)</label>
                  <input
                    type="date"
